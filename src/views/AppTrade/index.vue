<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p>
          <span
            class="s1"
            @click="changeDefaultAddress(address, userAddress)"
      ...
      <ul>
        <li>
          <b
            ...
            >件商品，总商品金额</b
          >
          <span>¥{{ userOrder.originalTotalAmount }}.00</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
    ...
    <div class="trade">
      <div class="price">
        应付金额:<span>¥{{ userOrder.totalAmount }}.00</span>
      </div>
      <div class="receiveInfo" v-if="userDefaultAddress">
        寄送至:
...
export default {
  ...
  computed: {
    ...mapState({
      userAddress: (state) => state.Trade.address,
      userOrder: (state) => state.Trade.order,
    ...
    async submitOrder() {
      ...
      try {
        await this.$store.dispatch("submitOrder", {
          tradeNo: this.userOrder.tradeNo,
          data,
        });
