      ...
      <div class="py-container">
        ...
        <div class="details clearfix">
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                ...
                <li :class="{ active: isTwo }">
                  <a href="javascript:void(0)" @click="changeOrder(2)"
                    >价格<span
                      v-show="isTwo"
                      class="iconfont"
                      :class="{
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id" @click="showDetail(good.id)">
                <div class="list-wrap">
                  <div class="p-img">
...
export default {
  ...
  methods: {
    sendSearchReq() {
      this.$store.dispatch("reqSearchList", this.searchParams);
    },
    removeBread() {
