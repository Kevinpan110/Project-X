    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <DetailZoom :imageList="skuInfo.skuImageList"/>
          <!-- 小图列表 -->
            ...
            <div class="chooseArea">
              ...
              <dl v-for="spu in spuSaleAttrList" :key="spu.id">
                ...
                <dd
                  ...
                  :key="spu1.id"
                  @click="changeActive(spu1, spu.spuSaleAttrValueList)"
                >
                  {{ spu1.saleAttrValueName }}
                </dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model.number.lazy="goodNum"/>
                <a href="javascript:" class="plus" @click="addGoodNum()">+</a>
                <a href="javascript:" class="mins" @click="subGoodNum()">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  props: ["skuId"],
  mounted() {
    this.getDetail(this.skuId);
  },
  methods: {
    getDetail(skuId) {
      this.$store.dispatch("goodDetail", skuId);
    },
